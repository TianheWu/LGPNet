...
def save_output(rgb_img, depth_img, grasp_q_img, grasp_angle_img, no_grasps=1, grasp_width_img=None, idx_fig=0, dataset='cornell', args=None):
    """
    Save the output of a gpnn
    :param rgb_img: RGB Image
    :param depth_img: Depth Image
    :param grasp_q_img: Q output of gpnn
    :param grasp_angle_img: Angle output of gpnn
    :param no_grasps: Maximum number of grasps to plot
    :param grasp_width_img: (optional) Width output of gpnn
    :return:
    """
    save_results_path = 'output/fig_results_{}/test_{}-{}/test_fig_{}'.format(dataset, args.start_split, args.end_split, idx_fig)
    ...
    # ax.set_title('RGB')
    ax.axis('off')
    fig.savefig(save_results_path + '/rgb.png', dpi=800)
    ...
    if depth_img.any():
        ...
        # ax.set_title('Depth')
        ax.axis('off')
        fig.savefig(save_results_path + '/depth.png', dpi=800)
    ...
    # ax.set_title('Grasp')
    ax.axis('off')
    fig.savefig(save_results_path + '/grasp.png', dpi=800)
    ...
    ax.axis('off')
    plt.colorbar(plot)
    fig.savefig(save_results_path + '/quality.png', dpi=800)
    ...
    ax.axis('off')
    plt.colorbar(plot)
    fig.savefig(save_results_path + '/angle.png', dpi=800)
    ...
    ax.axis('off')
    plt.colorbar(plot)
    fig.savefig(save_results_path + '/width.png', dpi=800)
